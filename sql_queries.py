...
songplay_table_create = ("""CREATE TABLE songplays (songplay_id SERIAL,   
                            ...
                            user_id INT NOT NULL, level VARCHAR(5),   
...
user_table_create = ("""CREATE TABLE IF NOT EXISTS users    
                    (user_id INT PRIMARY KEY, first_name VARCHAR,    
                     last_name VARCHAR, gender VARCHAR(1) NOT NULL, level varchar(5) NOT NULL);   
""")

song_table_create = ("""CREATE TABLE IF NOT EXISTS songs    
                    (song_id VARCHAR PRIMARY KEY, title VARCHAR NOT NULL,   
                     artist_id VARCHAR NOT NULL, year INT NOT NULL , duration DECIMAL(8,5) NOT NULL);   
""")
...
time_table_create = ("""CREATE TABLE time  
                    (start_time TIMESTAMP PRIMARY KEY, hour INT,    
                     day INT NOT NULL, week INT NOT NULL, month INT NOT NULL, year INT NOT NULL, weekday VARCHAR NOT NULL);   
""")
